...
sealed class RecoverableRawFileException(key: RawMediaKey, message: String, cause: Throwable? = null) :
    RawFileException(key, message, cause)

sealed class NonRecoverableRawFileException(key: RawMediaKey, message: String, cause: Throwable? = null) :
    RawFileException(key, message, cause)
